...
def strip_string_literals(code, state=None):
    ...
    EXAMPLES::
        ...
        sage: from sage_notebook.test.doctest_parser import strip_string_literals
...
def parse_optional_tags(string):
    ...
    EXAMPLES::
        ...
        sage: from sage_notebook.test.doctest_parser import parse_optional_tags
...
def parse_tolerance(source, want):
    ...
    EXAMPLES::
        ...
        sage: from sage_notebook.test.doctest_parser import parse_tolerance
...
def pre_hash(s):
    ...
    EXAMPLES::
        ...
        sage: from sage_notebook.test.doctest_parser import pre_hash
        sage: pre_hash("abc")
        '3:abc'
    """
    return "%s:%s" % (len(s), s)
...
def reduce_hex(fingerprints):
    ...
    EXAMPLES::
        ...
        sage: from sage_notebook.test.doctest_parser import reduce_hex
...
def make_marked_output(s, D):
    ...
    EXAMPLES::
        ...
        sage: from sage_notebook.test.doctest_parser import make_marked_output
...
class SageDocTestParser(doctest.DocTestParser):
    ...
    def __init__(self, long=False, optional_tags=()):
        ...
        EXAMPLES::
            ...
            sage: from sage_notebook.test.doctest_parser import SageDocTestParser
    ...
    def parse(self, string, *args):
        ...
        You can mark doctests as having a particular tolerance::
            ...
            '0.893515349287690\n'
            sage: type(ex.want)
            <class 'sage_notebook.test.doctest_parser.MarkedOutput'>
            sage: ex.want.tol
            2e-11
...
class SageOutputChecker(doctest.OutputChecker):
    ...
    EXAMPLES::
        ...
        sage: from sage_notebook.test.doctest_parser import SageOutputChecker, MarkedOutput, SageDocTestParser
        sage: import doctest
    ...
    def human_readable_escape_sequences(self, string):
        ...
        TESTS::
            ...
            sage: from sage_notebook.test.doctest_parser import SageOutputChecker
            sage: OC = SageOutputChecker()
            sage: teststr = '-'.join([
            ....:     'bold\x1b[1m', 
            ....:     'red\x1b[31m',
    ...
    def check_output(self, want, got, optionflags):
        ...
        EXAMPLES::
            ...
            sage: from sage_notebook.test.doctest_parser import MarkedOutput, SageOutputChecker
            sage: import doctest
            sage: optflag = doctest.NORMALIZE_WHITESPACE|doctest.ELLIPSIS
